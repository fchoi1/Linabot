...
rosbridge_path=/home/sarah/localros/brown-ros-pkg/experimental/rosbridge

#Path to the remote_lab package
remotelab_path=/home/sarah/localros/bosch-ros-pkg/trunk/stacks/remote_lab
...
dir=$remotelab_path/rosjs_resources/img
for file in `ls $dir`; do
   ln -sf $dir/$file img/$file
done
...
#ln -sf ../rosjs_resources/js/jquery js/jquery
#ln -sf ../rosjs_resources/js/json2 js/json2
#ln -sf ../rosjs_resources/js/RGraph js/RGraph
#ln -sf ../rosjs_resources/js/spidergl js/spidergl
