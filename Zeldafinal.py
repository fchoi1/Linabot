...
def play_Zelda(robot):
  ...
  Zelda6 = [(bes4,Q), (f4,Qd), (bes4,E), (bes4,S), (c5,S), (d5,S), (ees5,S), (f5,HALF), (f5,S), (f5,S), (f5,S), (ges5,S)]
  Zelda7 = [(aes5,HALFd), (c6,Q), (bes5,Q), (g5,HALF), (ees5,Q)]
  Zelda8 = [(f5,HALFd), (aes5,Q), (g5,Q), (ees5,HALF), (ees5,Q)]
  Zelda9 = [(ges5,HALFd), (bes5,Q), (a5,Q), (f5,HALF), (d5,Q)]
  Zelda10 = [(ees5,HALFd), (ges5,Q)]
  Zelda11 = [(f5, Q), (des5, HALF), (bes4, Q)]
  Zelda12 = [(c5,Ed),(d5,S),(e5,HALF),(g5,Q),(f5,E),(des4,S),(des4,S),(des4,E),(des4,S),(des4,S),(des4,E),(des4,S),(des4,S),(des4,E),(des4,E)] 
...
## robot.setSong( 1, Zelda6 )
  print("playing part 4")
  robot.setSong( 1, Zelda4 )
  robot.playSongNumber(1)
  time.sleep(MEASURE_TIME*2.01)

  print("playing part 5")
  robot.setSong( 2, Zelda5 )
  robot.playSongNumber(2)
  time.sleep(MEASURE_TIME*2.01)
  
  print("playing part 5")
  robot.setSong( 2, Zelda6 )
  robot.playSongNumber(2)
  time.sleep(MEASURE_TIME*2.01)
  
  print("playing part 5")
  robot.setSong( 2, Zelda7 )
  robot.playSongNumber(2)
  time.sleep(MEASURE_TIME*2.01)

    
  print("playing part 5")
  robot.setSong( 2, Zelda8 )
  robot.playSongNumber(2)
  time.sleep(MEASURE_TIME*2.01)  
  ...
  print("playing part 5")
  robot.setSong( 2, Zelda9 )
  robot.playSongNumber(2)
  time.sleep(MEASURE_TIME*2.01)
    
  print("playing part 5")
  robot.setSong( 2, Zelda10 )
  robot.playSongNumber(2)
  time.sleep(MEASURE_TIME*2.01)
    
  print("playing part 5")
  robot.setSong( 2, Zelda11 )
  robot.playSongNumber(2)
  time.sleep(MEASURE_TIME*2.01)

    
  print("playing part 5")
  robot.setSong( 2, Zelda12 )
  robot.playSongNumber(2)
  time.sleep(MEASURE_TIME*2.01)
